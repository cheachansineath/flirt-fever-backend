...
export class NewMigration1692002143862 implements MigrationInterface {
    name = 'NewMigration1692002143862'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying(50) NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "verify" boolean, "gender" character varying, "height" integer, "weight" integer, "age" integer, "location" character varying, "profile_url" character varying, "bio" character varying(100), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
